...
CREATE TABLE dbo.nightly_data (
    ...
    Volunteers_Hours INT, -- Hours that night, based on 7 delivery hours
...
PRINT("Copy view data into nightly_data - can take minutes");
...
SELECT
    ...
    7 AS Delivery_Hours,
    Volunteers_Total,
    Volunteers_Hours AS Volunteers_Hours,
    Real_Living_Wage_ AS Real_Living_Wage_,
    National_LivingWage_ AS National_LivingWage_,
    Patients_Treated AS Patients_Treated,
    DATA_SROI_ AS DATA_SROI_,
